...
})(
  {
    ...
    2: [
      function (_dereq_, module, exports) {
         ...
         */
        CardboardHMDVRDevice.prototype.setFieldOfView = function (
          opt_fovLeft,
          opt_fovRight,
          opt_zNear,
          opt_zFar
         ...
         */
        CardboardHMDVRDevice.prototype.setInterpupillaryDistance = function (
          ipd
        ) {
         ...
         */
        CardboardHMDVRDevice.prototype.setRenderRect = function (
          opt_rectLeft,
          opt_rectRight
        ) {
          if (opt_rectLeft) {
         ...
         * both eyes.
         */
        CardboardHMDVRDevice.prototype.setMonocularFieldOfView_ = function (
          angle
        ) {
          this.setFieldOfView(
        ...
        CardboardHMDVRDevice.prototype.createSymmetricalFieldOfView_ =
          function (angle) {
            return {
              upDegrees: angle,
              downDegrees: angle,
    ...
    3: [
      ...
      { "./sensor-sample.js": 8, "./three-math.js": 9, "./util.js": 11 },
    ],
    4: [
      function (_dereq_, module, exports) {
        /*
        ...
        function FusionPositionSensorVRDevice() {
          ...
          this.posePredictor = new PosePredictor(
            WebVRConfig.PREDICTION_TIME_S || 0.04
          );
        ...
        FusionPositionSensorVRDevice.prototype.onDeviceMotionChange_ =
        ...
        FusionPositionSensorVRDevice.prototype.setScreenTransform_ =
          function () {
    ...
    6: [
      function (_dereq_, module, exports) {
        ...
        MouseKeyboardPositionSensorVRDevice.prototype =
        ...
        MouseKeyboardPositionSensorVRDevice.prototype.onKeyDown_ = function (
          e
        ) {
        ...
        MouseKeyboardPositionSensorVRDevice.prototype.animateTheta_ = function (
          targetAngle
        ) {
          this.animateKeyTransitions_("theta", targetAngle);
        };

        MouseKeyboardPositionSensorVRDevice.prototype.animatePhi_ = function (
          targetAngle
        ) {
         ...
         */
        MouseKeyboardPositionSensorVRDevice.prototype.animateKeyTransitions_ =
          function (angleName, targetAngle) {
            ...
            this.angleAnimation = setInterval(
              function () {
        ...
        MouseKeyboardPositionSensorVRDevice.prototype.onMouseDown_ = function (
          e
        ) {
        ...
        MouseKeyboardPositionSensorVRDevice.prototype.onMouseMove_ = function (
          e
        ) {
        ...
        MouseKeyboardPositionSensorVRDevice.prototype.onMouseUp_ = function (
          e
        ) {
          this.isDragging = false;
        };

        MouseKeyboardPositionSensorVRDevice.prototype.isPointerLocked_ =
          function () {
            var el =
        ...
        MouseKeyboardPositionSensorVRDevice.prototype.resetSensor =
          function () {
      ...
      { "./base.js": 1, "./three-math.js": 9, "./util.js": 11 },
    ],
    7: [
      function (_dereq_, module, exports) {
        /*
    ...
    12: [
      function (_dereq_, module, exports) {
        ...
        var FusionPositionSensorVRDevice = _dereq_(
          "./fusion-position-sensor-vr-device.js"
        );
        var MouseKeyboardPositionSensorVRDevice = _dereq_(
