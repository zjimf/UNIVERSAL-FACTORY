(function e(t, n, r) {
...
})(
  {
      ...
      function (require, module, exports) {
        ...
        function ButtonManager() {
          ...
          settingsButton.addEventListener(
            "click",
            this.createClickHandler_("settings")
          );
        ...
        ButtonManager.prototype.setMode = function (mode, isVRCompatible) {
          ...
          switch (mode) {
            ...
            case Modes.VR:
              ...
              // VR at the moment.
              this.backButton.style.display = Util.isFirefox()
                ? "none"
                : "block";
              // Only show the settings button on mobile.
              var isSettingsVisible =
                Util.isMobile() || WebVRConfig.FORCE_ENABLE_VR;
              this.settingsButton.style.display = isSettingsVisible
                ? "block"
                : "none";
              this.aligner.show();
              break;
        ...
        ButtonManager.prototype.loadIcons_ = function () {
          ...
          this.ICONS = {};
          this.ICONS.cardboard = Util.base64(
            "image/svg+xml",
          ...
          this.ICONS.fullscreen = Util.base64(
            "image/svg+xml",
            ""
          );
          this.ICONS.exitFullscreen = Util.base64(
            "image/svg+xml",
            ""
          );
          this.ICONS.back = Util.base64(
            "image/svg+xml",
          ...
          this.ICONS.settings = Util.base64(
            "image/svg+xml",
    ...
    3: [
      function (require, module, exports) {
        ...
        CardboardDistorter.prototype.postRender = function () {
          ...
          this.shaderPass.render(
            this.genuineRender.bind(this.renderer),
            this.textureTarget
          );
        };
        ...
        CardboardDistorter.prototype.updateDeviceInfo = function (deviceInfo) {
          ...
          var params = {
            ...
            xTrans:
              (2 * (viewport.x + viewport.width / 2)) / (device.width / 2) - 1,
            yTrans:
              (2 * (viewport.y + viewport.height / 2)) / device.height - 1,
          };
         ...
         */
        CardboardDistorter.prototype.setDistortionCoefficients = function (
          coefficients
        ) {
      ...
      { "./distortion/barrel-distortion-fragment-v2.js": 5, "./util.js": 13 },
    ],
    4: [
      function (require, module, exports) {
        /*
        ...
        var Viewers = {
          ...
          CardboardV2: new CardboardViewer({
            ...
            inverseCoefficients: [
              ...
              -0.58208317, 0.21609078, -0.05444823, 0.009177956, -9.904169e-4,
              6.183535e-5, -1.6981803e-6,
            ],
          }),
        };
         ...
         */
        DeviceInfo.prototype.getProjectionMatrixLeftEye = function (
          opt_isUndistorted
        ) {
          var fov = this.getFieldOfViewLeftEye(opt_isUndistorted);
        ...
        DeviceInfo.prototype.getUndistortedParams_ = function () {
          ...
          var viewerMax = distortion.distortInverse(
            Math.tan(THREE.Math.degToRad(maxFov))
          );
      ...
      { "./distortion/distortion.js": 6, "./util.js": 13 },
    ],
    5: [
      function (require, module, exports) {
        var BarrelDistortionFragment = {
          ...
          uniforms: {
            ...
            projectionLeft: {
              type: "v4",
              value: new THREE.Vector4(1.0, 1.0, -0.5, -0.5),
            },
            unprojectionLeft: {
              type: "v4",
              value: new THREE.Vector4(1.0, 1.0, -0.5, -0.5),
    ...
    13: [
      function (require, module, exports) {
        ...
        Util.projectionMatrixToVector_ = function (matrix, opt_params) {
          ...
          vec
            .set(
              elements[4 * 0 + 0] * xScale,
              elements[4 * 1 + 1] * yScale,
              elements[4 * 2 + 0] - 1 - xTrans,
              elements[4 * 2 + 1] - 1 - yTrans
            )
            .divideScalar(2);
          return vec;
        };
    ...
    14: [
      function (require, module, exports) {
        ...
        function ViewerSelector(options) {
          ...
          try {
            this.selectedKey =
              localStorage.getItem(VIEWER_KEY) || DEFAULT_VIEWER;
          } catch (error) {
    ...
    16: [
      function (require, module, exports) {
        ...
        function WebVRManager(renderer, effect, params) {
          ...
          this.deviceInfo.viewer =
            DeviceInfo.Viewers[this.viewerSelector.selectedKey];
          ...
          this.getDeviceByType_(HMDVRDevice).then(
            function (hmd) {
              ...
              if (WebVRConfig.FORCE_DISTORTION) {
                ...
                if (
                  hmd.deviceName.indexOf("webvr-polyfill") == 0 &&
          ...
          this.getDeviceByType_(PositionSensorVRDevice).then(
            function (input) {
              this.input = input;
            }.bind(this)
          );
          ...
          this.getDeviceByType_(HMDVRDevice).then(
            function (hmd) {
              ...
              if (hmd.setFieldOfView) {
                ...
                hmd.setFieldOfView(
                  this.deviceInfo.getFieldOfViewLeftEye(this.isUndistorted),
      ...
      },
      {
        ...
        "./emitter.js": 9,
        "./modes.js": 11,
        "./rotate-instructions.js": 12,
        "./util.js": 13,
        "./viewer-selector.js": 14,
        "./wakelock.js": 15,
      },
    ],
  },
